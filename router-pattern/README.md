...
If a file is dropped into the S3 bucket, the lambda router will simply identify the extension of the file and decide on which service to forward the request. The challenge here is each file could have a unique logic on processing the data.
